...
python3 server.py -r $NBROUNDS -nbc $NBCLIENTS -b $VBATCHSIZE -fc $NBFITCLIENTS -ac $NBMINCLIENTS &
...
do
    python3 client.py -c $nb -nbc $NBCLIENTS -vb $VBATCHSIZE -b $BATCHSIZE -lr $LR -nm $NM -mgn $MGN -eps $EPS &
done
